...
import footer_image from "@/app/ui/front_page_cover_futuristic_planet.jpg";
  ...
  return (
    <footer>
        ...
        //   className="absolute inset-0"
          alt="image of stair and rolling ball"
          width={700}
          height={600}
        /> */}
            ...
            <div className="flex flex-cols justify-items-center">
              <div className="text center">
                ...
                <div className="pt-4">
                  <Link
                    href="/contactus"
                    className="text-lg underline font-medium text-[#001F3F] hover:text-[#3A6D8C]  hover:underline focus:outline-none focus:underline opacity-90"
                  >
                    Contact Us
                  </Link>
                </div>

                <ul className="mt-4 spacy-y-1 text-sm text-gray-700">
                  <li>Monday to Friday: 10 AM to 5 PM</li>
                  <li>Weekend: 10 AM to 3 PM</li>
                </ul>
          ...
          <div className="px-4 py-8 sm:px-6 col-start-3 mx-auto lg:col-span-1 lg:px-2">
            <div className="justify-center grid grid-cols-1 gap-2 sm:grid-cols-2">
              <div className="">
