...
//     undefined
//   );
  const replyDiscussionWithId = replyDiscussion.bind(null, discussionId, subject)
  return (
    <div>
      <form action={replyDiscussionWithId} className="bg-white p-4 rounded-lg shadow-md">
